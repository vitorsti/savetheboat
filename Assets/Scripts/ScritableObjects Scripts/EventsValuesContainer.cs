...
[CreateAssetMenu(fileName = "EventsValuesContainer", menuName = "ScriptableObject/eventsData", order = 0)]
public class EventsValuesContainer : ScriptableObject
{
    [Serializable]
